...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { address: @institution.address, city: @institution.city, country: @institution.country, email: @institution.email, legal_representant: @institution.legal_representant, name: @institution.name, nit: @institution.nit, region: @institution.region, telephone: @institution.telephone, website: @institution.website }
    end
